                    ...
                    <div class="row">
                        <div class="col-lg-12 margin-tb">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-primary text-light" href="{{ route('events.index') }}" enctype="multipart/form-data">
                                    بازگشت</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <form action="{{ route('events.update',$event->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group p-3">
                                        <strong>متن رویداد:</strong>


                                        <textarea class="form-control" name="body" id="exampleFormControlTextarea1"  placeholder="" rows="3">{{ $event->body }}</textarea>
                                        @error('title')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                    </div>

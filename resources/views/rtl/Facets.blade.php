                    ...
                    <form action="{{route('search')}}" method="get" id="searchForm">
                        <div class="input-group">
                            @if(is_array($results) && count($results)>0)
                                <input class="form-control  fontina vazirfont" id="myInput" name="q"  type="text" value="{{__('public.inputsearch')}}"  aria-describedby="button-search">
                            @else
                        ...
                        <div class="card-header">
                            ...
                            <div id="question-mini-list ">
                                <div>
                                        ...
                                        <div class="notexitst">
                                            <h4 class="text-center m-5 vazirfont" id="">
                                                نتیجه ای برای فیلتر اعمال شده یافت نشد
                                            </h4>

                                            <a href="/">بازگشت </a>
                                            <br>
                                            <img src="{{asset('images/machine.gif')}}" alt="" style="width: 200px;height: 200px">
                                        </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(document).on( "click" , "#submenu1 li" , function () {
                        ...
                        $("#added-item").append("<li><a href='#' class='link-dark rounded '><span class='ms-1 d-none d-sm-inline text-danger'> " + text + " <i class='fa fa-remove remove1  mr-5 text-danger' id='removetag'></i></span></a></li>") ;
                    ...
                    $(document).on("click" ,".remove1" ,function () {
                        ...
                        $("#submenu1").append(" <li class='dropdown'><a href='#' class='link-dark rounded text-danger'>  <span class='pr-20'>" +
                            "" + text + " </span> </a></li> ");
                    });
                    ...
                    $(document).on( "click" , "#submenu2 li" , function () {
                        ...
                        var text = $(this).find("a").text() ;
                        var textspan = $("#textlang").text() ;

                        var textparam= addparameter('langs[]='+textspan);
                        $("#added-item").append("<li><a href='#' class='link-dark rounded '><span class='ms-1 d-none d-sm-inline text-danger'> " + text + " <i class='fa fa-remove remove2  mr-5 text-danger' id='removetag'></i></span></a></li>") ;
                    ...
                    $(document).on("click" ,".remove2" ,function () {
                        ...
                        $("#submenu2").append(" <li class='dropdown'><a href='#' class='link-dark rounded text-danger'>  <span class='pr-20'>" +
                            "" + text + " </span> </a></li> ");
                    });
                ...
                function text346(x){
                    var textparam= addparameter('tags[]='+x);
                    // alert(x);
                    // console.log(x)
                }

    ...
    <div class="form-container sign-up-container">
        ...
        <form action="{{ route('register.custom') }}" method="POST">
            ...
            @csrf
                ...
                <input type="text" placeholder="نام کاربری " id="name" class="form-control" name="name"
                       required autofocus>
                @if ($errors->has('name'))
                ...
                <input type="text" placeholder="ایمیل" id="email_address" class="form-control"
                ...
                <input type="password" placeholder="پسورد" id="password" class="form-control"
            ...
            <div class="d-grid mx-auto">
                <button type="submit" class="btn btn-dark btn-block">  ثبت</button>
            </div>
        </form>
    </div>
    ...
    <div class="overlay-container">
        <div class="overlay">
            <div class="overlay-panel overlay-left">
                <h1>{{__('public.Hi dear friend')}}</h1>
                <p>{{__('public.SignIntext1')}}</p>
